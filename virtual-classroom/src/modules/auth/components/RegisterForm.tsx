...
export const RegisterForm = () => {
  ...
  const handleSubmit = () => {
    // Hook up to your auth service here
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs text-slate-400">O regístrate con tu correo</span>
        <div className="h-px flex-1 bg-slate-200" />
      </div>
      ...
      <button
        ...
        className="mt-1 w-full rounded-lg bg-[#1B3D6F] py-3 text-sm font-bold text-white shadow-sm transition hover:bg-[#163261] active:scale-[0.99]"
      >
        Crear Cuenta
      </button>
    </div>
